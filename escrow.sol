...
mapping(string => uint8) existingID;
...
_receiver, address payable _agent,uint256 amount) public payable {

require(msg.sender != address(0), "Sender should not be null");
require(_receiver != address(0), "Receiver should not be null");
////////////////////////////////////////////////////////////////
require(_referenceId !=1,"ID exist" )
require(msg.value == amount,"deposit amount error")
////////////////////////////////////////////////////////////
...
//////////////////////////////////////////////
existingID[_referenceId] = 1;

///////////////////////////send Eth to compund address and get CETH///////////////////////////////////////
...
function withdraw(string memory _referenceId, uint256 _amount ) returns(bool)
public {
...
///////////get ETH from compound address and send ETH to withdrawer/////////////////////////
    CEth cToken = CEth(_cEtherContract);
