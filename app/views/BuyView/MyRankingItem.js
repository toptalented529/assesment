  ...
  return (
    <View style={styles.priceContainer}>
      <LinearGradient
        ...
        style={styles.RankingBox}>
        {
          ...
          <View style = {{justifyContent:"center", alignItems:"center"}}>
            ...
            <View style = {{justifyContent:"center",alignItems:"center",marginBottom:12,}}>
              ...
              <Text  style = {{fontWeight:"normal",fontSize:16}}>You completed all the ranks</Text>
            </View>
          </View>
        }
        <View style={{ flexDirection: "row" }}>
          ...
          <View style={{ flexDirection: "column", marginRight: width * 0.05, }}>
            ...
            <Text style={{ fontSize: 24, fontWeight: "bold" }}>{user && Ranges[user.range -1].name }<Text style={{ fontWeight: "normal" }}> Balance</Text></Text>
      ...
      <View style={{ alignSelf: "center" }}>
        <Text style={{ color: "#fff", marginVertical: height * 0.02 }}>Next Promotion</Text>
